 ...
 * 如果你不想它出现在侧边栏里，可以设置 hidden: true，这样它就隐藏了，不会出现在侧边栏，而是通过其他方式进行触发
 * 例如： login，我们希望是在点击头像的时候弹出来
 */
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '租户流量统计',
        meta: { title: '租户流量统计', icon: 'component', affix: false },
        hidden: true
      },
      {
        path: 'app_create',
        ...
        name: '添加租户',
        meta: { title: '添加租户', icon: 'component', affix: false },
        hidden: true
      },
      {
        path: 'app_edit/:id(\\d+)',
        component: () => import('@/views/app/app'),
        name: '修改租户信息',
        meta: { title: '修改租户信息', icon: 'component', affix: false },
        hidden: true
      }
    ]
  }
